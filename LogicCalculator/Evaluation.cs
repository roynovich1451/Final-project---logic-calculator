...
namespace LogicCalculator
{
    internal class Evaluation
    {
        ...
        private void Or_Introduction_One()
        {
            ...
            is_valid = statement_list[current_line].expression.Contains(statement_list[row].expression + "V")
        ...
        private void Or_Introduction_Two()
        {
            ...
            if (row == -1)
                return;
            is_valid = statement_list[current_line].expression.Contains("V" + statement_list[row].expression)
        ...
        {
            int start_row = Get_Lines_From_Segment(statement_list[current_line].first_segment)[0],
            end_row = Get_Lines_From_Segment(statement_list[current_line].first_segment)[1];
